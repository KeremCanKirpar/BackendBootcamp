...
{
    new Customer { Name = "John Doe", ContactName = "John Doe", Email = "john.doe@gmail.com", PhoneNumber = "+90 555 111 22 33", Address = "Kadıköy, İstanbul", City = "İstanbul", Country = "Türkiye", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsDeleted = false },
    new Customer { Name = "Jane Smith", ContactName = "Jane Smith", Email = "jane.smith@gmail.com", PhoneNumber = "+90 555 222 33 44", Address = "Beyoğlu, İstanbul", City = "İstanbul", Country = "Türkiye", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsDeleted = false },
    new Customer { Name = "Ali Yıldız", ContactName = "Ali Yıldız", Email = "ali.yildiz@gmail.com", PhoneNumber = "+90 555 333 44 55", Address = "Ankara, Çankaya", City = "Ankara", Country = "Türkiye", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsDeleted = false },
    new Customer { Name = "Fatma Demir", ContactName = "Fatma Demir", Email = "fatma.demir@gmail.com", PhoneNumber = "+90 555 444 55 66", Address = "İzmir, Konak", City = "İzmir", Country = "Türkiye", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsDeleted = false },
    new Customer { Name = "Mustafa Tekin", ContactName = "Mustafa Tekin", Email = "mustafa.tekin@gmail.com", PhoneNumber = "+90 555 555 66 77", Address = "Antalya, Muratpaşa", City = "Antalya", Country = "Türkiye", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsDeleted = false },
    new Customer { Name = "Ayşe Çetin", ContactName = "Ayşe Çetin", Email = "ayse.cetin@gmail.com", PhoneNumber = "+90 555 666 77 88", Address = "Bursa, Nilüfer", City = "Bursa", Country = "Türkiye", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsDeleted = false },
    new Customer { Name = "Mehmet Özdemir", ContactName = "Mehmet Özdemir", Email = "mehmet.ozdemir@gmail.com", PhoneNumber = "+90 555 777 88 99", Address = "Konya, Meram", City = "Konya", Country = "Türkiye", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsDeleted = false },
    new Customer { Name = "Emine Aksoy", ContactName = "Emine Aksoy", Email = "emine.aksoy@gmail.com", PhoneNumber = "+90 555 888 99 00", Address = "İstanbul, Beşiktaş", City = "İstanbul", Country = "Türkiye", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsDeleted = false },
    new Customer { Name = "Okan Kızıl", ContactName = "Okan Kızıl", Email = "okan.kizil@gmail.com", PhoneNumber = "+90 555 999 00 11", Address = "İzmir, Bornova", City = "İzmir", Country = "Türkiye", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsDeleted = false },
    new Customer { Name = "Deniz Aydoğan", ContactName = "Deniz Aydoğan", Email = "deniz.aydogan@gmail.com", PhoneNumber = "+90 555 101 11 22", Address = "İstanbul, Kadıköy", City = "İstanbul", Country = "Türkiye", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsDeleted = false },
    new Customer { Name = "Büşra Sarı", ContactName = "Büşra Sarı", Email = "busra.sari@gmail.com", PhoneNumber = "+90 555 202 22 33", Address = "Antalya, Kepez", City = "Antalya", Country = "Türkiye", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsDeleted = false },
    new Customer { Name = "Serkan Yılmaz", ContactName = "Serkan Yılmaz", Email = "serkan.yilmaz@gmail.com", PhoneNumber = "+90 555 303 33 44", Address = "Ankara, Altındağ", City = "Ankara", Country = "Türkiye", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsDeleted = false }
};
    public List<Supplier> Suppliers = new List<Supplier>
{
    new Supplier { Name = "TechSupply Inc.", ContactName = "Ali Yılmaz", Email = "ali@techsupply.com", PhoneNumber = "+90 555 123 45 67", Address = "İstanbul, Avcılar", City = "İstanbul", Country = "Türkiye", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsDeleted = false },
    new Supplier { Name = "Furniture World", ContactName = "Mehmet Kaya", Email = "mehmet@furnitureworld.com", PhoneNumber = "+90 555 234 56 78", Address = "Ankara, Çankaya", City = "Ankara", Country = "Türkiye", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsDeleted = false },
    new Supplier { Name = "ClothShop", ContactName = "Fatma Demir", Email = "fatma@clothshop.com", PhoneNumber = "+90 555 345 67 89", Address = "İzmir, Konak", City = "İzmir", Country = "Türkiye", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsDeleted = false },
    new Supplier { Name = "Gourmet Foods", ContactName = "Zeynep Yüksel", Email = "zeynep@gourmetfoods.com", PhoneNumber = "+90 555 456 78 90", Address = "Antalya, Muratpaşa", City = "Antalya", Country = "Türkiye", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsDeleted = false },
    new Supplier { Name = "SportGear", ContactName = "Ahmet Sönmez", Email = "ahmet@sportgear.com", PhoneNumber = "+90 555 567 89 01", Address = "Bursa, Nilüfer", City = "Bursa", Country = "Türkiye", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsDeleted = false },
    new Supplier { Name = "SuperTech Ltd.", ContactName = "Ayşe Çetin", Email = "ayse@supertech.com", PhoneNumber = "+90 555 678 90 12", Address = "İstanbul, Beşiktaş", City = "İstanbul", Country = "Türkiye", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsDeleted = false },
    new Supplier { Name = "HomeLux", ContactName = "Kadir Çalışkan", Email = "kadir@homelux.com", PhoneNumber = "+90 555 789 01 23", Address = "Konya, Meram", City = "Konya", Country = "Türkiye", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsDeleted = false }
};
