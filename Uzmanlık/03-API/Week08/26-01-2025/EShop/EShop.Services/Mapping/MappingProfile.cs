    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            #region  Cart
                ...
                .ForMember(dest=>dest.ApplicationUser, opt=>opt
                .MapFrom(src=>src.ApplicationUser))
                .ForMember(dest=>dest.CartItems,opt=>opt
                .MapFrom(src=>src.CartItems)).ReverseMap();
            ...
            .MapFrom(src=>src.OrderItems)).ReverseMap();
            #endregion
            #region OrderItem
            CreateMap<OrderItem,OrderItemDto>()
            .ForMember(dest=>dest.Product,opt=>opt
            .MapFrom(src=>src.Product)).ReverseMap();
            #endregion
        }
    }
}
